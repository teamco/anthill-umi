  ...
  return {
    ...
    columns: [
        ...
        render(name, data) {
          ...
          return (
            <div className={styles.nowrap}>
              ...
              <span
                className={
                  currentUser?.uid === data.uid ? styles.currentUser : null
                }
              >
                {name}
              </span>
      ...
      },
      {
        ...
        render: (metadata) => (
          <Tag
            color={metadata.signedIn ? 'cyan' : 'lightgrey'}
      ...
      },
      {
        ...
        render: (record) =>
          data.length ? (
            <div className={styles.nowrap}>
              <Popconfirm
                title={t('msg:deleteConfirm', { instance: record.email })}
                placement={'topRight'}
              ...
              {record.metadata.signedIn ? (
                <Popconfirm
                  title={t('auth:signOutConfirm', { instance: record.email })}
                  placement={'topRight'}
              ...
              {record.metadata.isLocked ? (
                <Popconfirm
                  title={t('auth:unlockConfirm', { instance: record.email })}
                  placement={'topRight'}
    ...
    content: (
      <div className={styles.profile}>
        ...
        <div style={{ flex: '40%' }}>
          ...
          <div>
            <strong>{t('auth:lastSignInTime')}</strong>
          </div>
          <div>
